...
st.header("Please give the following vales")

variable1 = st.number_input("Constant_fk2d")
variable2 = st.number_input("Multiplying_factor_3d")
st.subheader("Velocity (in the format x**y)")
variable0 = st.number_input("x")
variable4 = st.number_input("y")
...
variable5 = pow(variable0,variable4)


st.subheader("""Filtering Method
1. C
2. S
3. A
4. C & S
...
if variable6 == 1:
    ...
    variable8 = st.number_input("Enter thresold value S:")
elif variable6 == 3:
    variable9 = st.number_input("Enter Lambda value for A:")
    variable10 = st.number_input("Enter k value for A:")
elif variable6 == 4:
    variable7 = st.number_input("Enter thresold value C:")
    variable8 = st.number_input("Enter thresold value s:")
elif variable6 == 5:
    ...
    variable9 = st.number_input("Enter Lambda value for A:")
    variable10 = st.number_input("Enter k value for A:")
elif variable6 == 7 or variable6 == 8:
    variable7 = st.number_input("Enter thresold value C:")
    variable8 = st.number_input("Enter thresold value S:")
    variable9 = st.number_input("Enter Lambda value for A:")
    variable10 = st.number_input("Enter k value for A:")
...
st.subheader("""Replacement method
1. previous point
2. 2*last-2nd_last
3. overall_mean
4. 12_point_strategy
...
if st.button('Compute'):
    ...
    def fk():
        ...
        constant_fk2d=variable1
        multiplying_factor_3d=variable2
        Shear_velocity=variable5
    ...
    print('Chose Filtering Method From Above:')
    tch = variable6
    if tch == 1:
        print('Enter thresold value C:')
        corr = variable7
    elif tch == 2:
        print('Enter thresold value S:')
        SNR = variable8
    elif tch == 3:
        print('Enter Lambda value for A:')
        Lambda = variable9
        print('Enter k value for A:')
        k = variable10
        print(Lambda,k)
    elif tch == 4:
        print('Enter thresold value C:')
    ...
    print('Chose Replacement Method From Above:')
    sch = variable11
    if sch> 7:
        print('Please enter correct choice...')
    else:
